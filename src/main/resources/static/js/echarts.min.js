...
function(t, e) {
	...
	function d(t, e, i) {
		if (t && e) if (t.forEach && t.forEach === h_) t.forEach(e, i);
	...
	function P(t) {
		return null == t ? null : "function" == typeof t.trim ? t.trim() : t.replace(/^[\s﻿ ]+|[\s﻿ ]+$/g, "")
	}
	function N(t) {
		t[y_] = !0
	}
	...
	function Ht(t, e, i) {
		...
		else for (r = n; r < o; r++) t.push(1 === i ? e[r] : K_.call(e[r]));
	...
	function Ut(t, e, i, n, o, a, r, s, l) {
		var u = t.length;
		if (1 == l) for (c = 0; c < u; c++) s[c] = Xt(t[c], e[c], i[c], n[c], o, a, r);
		else for (var h = t[0].length, c = 0; c < u; c++) for (var d = 0; d < h; d++) s[c][d] = Xt(t[c][d], e[c][d], i[c][d], n[c][d], o, a, r)
	}
			...
			if (a || !x) {
				...
				var N = new vt({
					...
					onframe: function(t, e) {
						...
						L = i, k = e;
						var n = m[i + 1] - m[i];
						if (0 !== n) if (I = (e - m[i]) / n, l) if (D = v[i], T = v[0 === i ? i : i - 1], A = v[i > u - 2 ? u - 1 : i + 1], C = v[i > u - 3 ? u - 1 : i + 2], d) Ut(T, D, A, C, I, I * I, I * I * I, r(t, o), g);
						else {
	...
	function ga(t, e, i, n) {
		if (null == n && (n = 1 / 0), e === SM) for (a = 0; a < i.length && a < n; a++) t(i[a] ? i[a][0] : null, a);
	...
	function _a(t, e, i, n, o, a) {
		...
		if (S(t)) return !1;
		var l;
		if (n && (l = w(l = n[a]) ? l.name : l), e === vM) if (i === SM) {
		...
		} else if (e === mM) for (h = 0; h < t.length && h < 5; h++) {
			var d = t[h],
				f = Ii(d);
			if (!y(f)) return !1;
	...
	function Ra(t) {
		var e = t && t.itemStyle;
		if (e) for (var i = 0, o = RM.length; i < o; i++) {
			var a = RM[i],
				r = e.normal,
				s = e.emphasis;
	...
	function Va(t, e) {
		var i = EM(t) && t[e],
			n = EM(i) && i.textStyle;
		if (n) for (var o = 0, a = ib.length; o < a; o++) {
			var e = ib[o];
	...
	function mr(t, e) {
		if (t && (t.trigger(e), "group" === t.type)) for (var i = 0; i < t.childCount(); i++) mr(t.childAt(i), e)
	}
	function vr(t, e, i) {
		var n = Pi(t, e);
	...
	function nl(t, e, i, n) {
		...
		if (!t) return o;
		e[0] < i[0] && o.push(e[0]);
		for (var a = i[0]; a <= i[1] && (o.push(a), (a = pT(a + t, n)) !== o[o.length - 1]);) if (o.length > 1e4) return [];
	...
	function bu(t, e) {
		...
		isNaN(n) && (n = 0);
		for (var o = e.count(), a = Math.max(1, Math.round(o / 5)), r = 0; r < o; r += a) if (1.5 * Kl.getSymbolSize(e, r)[t.isHorizontal() ? 1 : 0] > n) return !1;
		return !0
	}
	function Su(t) {
		return this._axes[t]
	...
	function Au(t, e, i) {
		...
		if (r) if (null == s) {
			for (var l in o) if (o.hasOwnProperty(l) && Cu(o[l])) {
				n = o[l];
				break
			}
		} else Cu(o[s]) && (n = o[s])
	...
	function Ef(t) {
		return t = Bf(t), function(e, i) {
			return xo(e, t)
		}
	}
	function Rf(t, e) {
		return t = Bf(t), function(i) {
			var n = null != e ? e : i,
	...
	var _w = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) ||
	function(t) {
		setTimeout(t, 16)
	}, ww = new F_(50), bw = {}, Sw = 0, Mw = 5e3, Iw = /\{([a-zA-Z0-9_]+)\|([^}]*)\}/g, Tw = "12px sans-serif", Dw = {};
	...
	function(t) {
		...
		function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, D_.call(this)
	};
	Bw.prototype = {
		constructor: Bw,
		addClip: function(t) {
	...
	var pS = In.extend({
		...
		mS = function(t) {
			return a_.browser.ie && a_.browser.version >= 11 ?
			function() {
				...
				if (t.apply(this, arguments), e) for (var l = 0; l < gS.length; l++) n[gS[l][0]] = gS[l][2]
			} : t
		},
		vS = In.extend({
			type: "sector",
	...
	var dM = {
		...
		gradientColor: ["#96c3ec", "#76b1e5", "#4790d4"],
		textStyle: {
	...
	jM.perform = function(t) {
		...
		if (this._dueEnd = i ? i._outputDueEnd : this._count ? this._count(this.context) : 1 / 0, this._progress) {
			...
			if (!n && (h || d < f)) {
				...
				if (y(p)) for (var g = 0; g < p.length; g++) ar(this, p[g], d, f, l, u);
	...
	var qM = Ni(),
		KM = hM.extend({
			...
			fillDataTextStyle: function(t) {
				if (t && !S(t)) for (var e = ["show"], i = 0; i < t.length; i++) t[i] && t[i].label && Mi(t[i], "label", e)
			},
			...
			formatTooltip: function(t, e, i) {
				...
				}(s) : n(r ? er(o, t, a[0]) : l ? s[0] : s), c = jo(u), f = o.getName(t), g = this.name;
	...
	lT.type = "list", lT.hasItemOption = !0, lT.getDimension = function(t) {
		...
		} else for (var n = new(e = As(this))(this.count()), o = 0; o < n.length; o++) n[o] = o;
		return n
	}, lT.get = function(t, e) {
		...
		if (this._count) {
			...
			if (n) {
				...
				if (!this._indices) {
					var c = 0;
					if (1 === n) {
						for (var d = this._storage[e[0]], f = 0; f < this._chunkCount; f++) for (var p = d[f], g = Math.min(this._count - f * this._chunkSize, this._chunkSize), m = 0; m < g; m++)((w = p[m]) >= l && w <= u || isNaN(w)) && (a[r++] = c), c++;
						h = !0
					} else if (2 === n) {
		...
		if (tT(t)) for (var i in t) t.hasOwnProperty(i) && this.setVisual(i, t[i]);
		else this._visual = this._visual || {}, this._visual[t] = e
	}, lT.setLayout = function(t, e) {
		if (tT(t)) for (var i in t) t.hasOwnProperty(i) && this.setLayout(i, t[i]);
		...
		if (this._itemVisuals[t] = n, tT(e)) for (var a in e) e.hasOwnProperty(a) && (n[a] = e[a], o[a] = !0);
		else n[e] = i, o[e] = !0
	...
	Cl.prototype = {
		...
		contain: function(t) {
			...
			t: for (var n = 0, o = i.length; n < o; n++) if ("polygon" === i[n].type) {
				var a = i[n].exterior,
					r = i[n].interiors;
				if (Al(a, t[0], t[1])) {
					for (var s = 0; s < (r ? r.length : 0); s++) if (Al(r[s])) continue t;
					return !0
				}
			}
			return !1
		...
		transformTo: function(t, e, i, n) {
			var o = this.getBoundingRect(),
				a = o.width / o.height;
			i ? n || (n = i / a) : i = a * n;
			for (var r = new $t(t, e, i, n), s = o.calculateTransform(r), l = this.geometries, u = 0; u < l.length; u++) if ("polygon" === l[u].type) {
	...
	ys({
		...
		_buildSplitLineAndArea: function(t) {
			...
			if (n.length) {
				...
				var m = [],
					v = [];
				if ("circle" === o) for (var x = n[0].getTicksCoords(), _ = i.cx, w = i.cy, b = 0; b < x.length; b++) h && m[A = e(m, p, b)].push(new pS({
					shape: {
						cx: _,
						cy: w,
						r: x[b].coord
	...
	], cA = 0; cA < hA.length; cA++) for (var dA = 0; dA < hA[cA].length; dA++) hA[cA][dA][0] /= 10.5, hA[cA][dA][1] /= -14, hA[cA][dA][0] += uA[0], hA[cA][dA][1] += uA[1];
	var fA = {
		"南海诸岛": [32, 80],
		"广东": [0, -10],
		"香港": [10, 5],
	...
	var UA = ZA.visualHandlers = {
		...
		symbol: {
			applyVisual: function(t, e, i) {
				...
				if (_(n)) i("symbol", n);
				else if (FA(n)) for (var o in n) n.hasOwnProperty(o) && i(o, n[o])
			},
			_doMap: {
				linear: Wc,
				category: Hc,
	...
	gC.isPersistent = function() {
		...
		for (var i = t.start; i < t.end; i++) if (Ad(e.getItemLayout(i))) {
	...
	var GC = hM.extend({
		...
		getActiveState: function(t) {
			...
			} else for (var n = 0, o = e.length; n < o; n++) if (e[n][0] <= t && t <= e[n][1]) return "active";
			return "inactive"
		}
	}),
		WC = {
	...
	sP.setOutputRanges = function(t, e) {
		...
		for (var i = this._targetInfoList, n = Mv(e, t), o = 0; o < i.length; o++) {
			...
			} else for (o = 0; o < uP.length; o++) if (uP[o](n, a)) return a
		}
		return !0
	};
	var lP = {
	...
	Qy.defaultOption = {
		...
		if (o.href = r, "function" != typeof MouseEvent || a_.browser.ie || a_.browser.edge) if (window.navigator.msSaveOrOpenBlob) {
