package com.ljx.tcwj4.controller;
...
import com.ljx.tcwj4.websocket.TakeawayOrderWebSocket4Server;
 ...
 */
@RestController()
@RequestMapping("/takeawayOrder4")
public class TakeawayOrder4Controller {
    ...
    public TakeawayOrderDO addAndQueryByUserId(TakeawayOrderDO takeawayOrderDO) {
        ...
        // 通知前端，向前台发送消息
        TakeawayOrderWebSocket4Server.sendMessageToWebsocketJs(takeawayOrderDO.getUserId(), JSON.toJSONString(takeawayOrderChartDTO));
        return result;
    }
    /**
