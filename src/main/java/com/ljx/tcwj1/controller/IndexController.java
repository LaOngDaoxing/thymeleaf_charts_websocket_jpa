...
public class IndexController {
    /**
      跳转到的前台页面路径前缀
     */
    private String userPrefix="general_jsp/tcwjJsp1/user/";
    private String takeawayOrderPrefix="general_jsp/tcwjJsp1/takeawayOrder/";
     ...
     * @ApiGrammer规则：
            SpringBoot项目在启动后，首先会去静态资源路径（resources/static/）下查找 index.html 作为首页文件。
            如果在静态资源路径（resources/static/）下找不到 index.html，则会到（resources/templates/）目录下找 index.html（使用 Thymeleaf 模版）作为首页文件。
            由上可知，默认路径前缀是resources/static/或resources/templates/。
     * @return
     */
    @RequestMapping("/toLogin")
    public String  toLogin(){
        return "general_jsp/loginJsp/login";
    }
    /**
     * webUrl测试http://localhost:8090/thymeleaf_charts_websocket_jpa/index1/toQueryByUserIdIndex
    ...
    /**
     * webUrl测试http://localhost:8090/thymeleaf_charts_websocket_jpa/index1/toByUserIdAdd
     * @return
     */
    ...
    /**
     * webUrl测试http://localhost:8090/thymeleaf_charts_websocket_jpa/index1/toQueryByUserIdAndParamsIndex
    ...
    /**
     * webUrl测试http://localhost:8090/thymeleaf_charts_websocket_jpa/index1/toByUserIdAndParamsAdd
     * @return
     */
